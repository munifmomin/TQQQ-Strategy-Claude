"""
Event-driven daily backtest engine (index-based, INITIAL_CAPITAL).
Supports fractional multi-instrument holdings.
...
def run_backtest(allocations: pd.DataFrame,
    ...
    prices: DataFrame of Close prices (and Open, if available), columns = tickers.

    Returns:
      portfolio: daily portfolio value + target/weight
