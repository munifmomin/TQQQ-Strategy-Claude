...
from tqqq_bvt.config import WF_IN_SAMPLE_END, WF_OUT_SAMPLE_START, WF_ROLLING_YEARS, WF_STEP_MONTHS
...
def check_red_flags(is_metrics: dict, oos_metrics: dict) -> list[str]:
    """Flag any metric degrading >50% IS→OOS."""
    flags = []
...
def rolling_windows(equity: pd.Series,
    ...
    """Return rolling window CAGR and MDD."""
    rows = []
